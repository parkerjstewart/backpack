...
export default function ModuleReviewPage() {
  ...
  // Keep the learning-goals column constrained to the left column height.
  useEffect(() => {
    if (phase !== "revealed") {
    ...
    const updateHeight = () => {
      const nextHeight = Math.ceil(leftColumnElement.getBoundingClientRect().height);
            ...
            {phase === "uploading" ? (
              ...
              >
                <div className="flex items-start gap-6">
                  {/* Left column - Module info (sets row height) */}
                  <motion.div
                    ref={leftColumnRef}
                  ...
                  {/* Center column - Learning goals (stretches to left column height, scrolls internally) */}
                  <motion.div
