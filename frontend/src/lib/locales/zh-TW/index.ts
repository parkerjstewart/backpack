export const zhTW = {
  ...
  tutor: {
    reviewSession: "複習會話",
    initializing: "正在啟動複習會話...",
    startingSession: "正在準備你的複習會話...",
    currentGoal: "目前目標",
    goals: "目標",
    complete: "完成",
    sessionComplete: "複習會話已完成！做得很好。",
    responsePlaceholder: "輸入你的回覆...",
    tryTutor: "試用導師",
    tryTutorDescription: "在發佈前先用你的模組測試導師代理。",
    publish: "發佈模組",
    publishing: "發佈中...",
    discard: "捨棄草稿",
    discarding: "正在捨棄...",
    tryAgain: "再試一次",
    publishConfirm: "你對導師效果滿意嗎？發佈此模組以使其可用。",
    discardConfirm: "確定嗎？這將刪除草稿模組及其所有資料。",
  },
}
