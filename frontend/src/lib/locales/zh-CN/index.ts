export const zhCN = {
  ...
  tutor: {
    reviewSession: "复习会话",
    initializing: "正在启动复习会话...",
    startingSession: "正在准备你的复习会话...",
    currentGoal: "当前目标",
    goals: "目标",
    complete: "完成",
    sessionComplete: "复习会话已完成！做得很好。",
    responsePlaceholder: "输入你的回答...",
    tryTutor: "试用导师",
    tryTutorDescription: "在发布前先用你的模块测试导师代理。",
    publish: "发布模块",
    publishing: "发布中...",
    discard: "丢弃草稿",
    discarding: "正在丢弃...",
    tryAgain: "再试一次",
    publishConfirm: "你对导师效果满意吗？发布该模块以使其可用。",
    discardConfirm: "确定吗？这将删除草稿模块及其所有数据。",
  },
}
