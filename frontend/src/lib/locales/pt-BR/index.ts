export const ptBR = {
  ...
  searchPage: {
    ...
    pressToSubmit: "Enter para enviar (Shift+Enter para nova linha)",
  ...
  tutor: {
    ...
    initializing: "Iniciando sessão de revisão...",
    startingSession: "Preparando sua sessão de revisão...",
    currentGoal: "Objetivo Atual",
    goals: "objetivos",
    complete: "Concluído",
    sessionComplete: "Sessão de revisão concluída! Ótimo trabalho.",
    responsePlaceholder: "Digite sua resposta...",
    tryTutor: "Testar Tutor",
    tryTutorDescription: "Teste o agente tutor com seu módulo antes de publicar.",
    publish: "Publicar Módulo",
    publishing: "Publicando...",
    discard: "Descartar Rascunho",
    discarding: "Descartando...",
    tryAgain: "Tentar Novamente",
    publishConfirm: "Está satisfeito com o tutor? Publique este módulo para disponibilizá-lo.",
    discardConfirm: "Tem certeza? Isso excluirá o módulo de rascunho e todos os seus dados.",
  }
}
