export const jaJP = {
  ...
  searchPage: {
    ...
    pressToSubmit: "Enterで送信（Shift+Enterで改行）",
  ...
  tutor: {
    ...
    initializing: "レビューセッションを開始しています...",
    startingSession: "レビューセッションを準備しています...",
    currentGoal: "現在のゴール",
    goals: "ゴール",
    complete: "完了",
    sessionComplete: "レビューセッションが完了しました。お疲れさまでした。",
    responsePlaceholder: "回答を入力してください...",
    tryTutor: "Tutorを試す",
    tryTutorDescription: "公開前にこのモジュールでTutorエージェントを試してください。",
    publish: "モジュールを公開",
    publishing: "公開中...",
    discard: "下書きを破棄",
    discarding: "破棄中...",
    tryAgain: "もう一度試す",
    publishConfirm: "Tutorに満足していますか？このモジュールを公開して利用可能にします。",
    discardConfirm: "本当によろしいですか？下書きモジュールとそのデータを削除します。",
  }
}
